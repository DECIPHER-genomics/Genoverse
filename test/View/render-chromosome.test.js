...
describe('Correctly render a chromosome:', () => {
  ...
  it('with all band types', () => testTrackRenderStatic(undefined, { _testClass: Genoverse.Track.Chromosome, featureHeight: 20 }, [
  ...
  it('with only one band', () => testTrackRenderStatic(undefined, { _testClass: Genoverse.Track.Chromosome, featureHeight: 20 }, [
